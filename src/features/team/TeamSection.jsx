...
const TeamSection = ({ staff = [] }) => {
    ...
    return (
        <SectionContainer background="default" id="staff" animation={sectionAnimation}>
            <Container maxWidth="lg">
                <TitleSection 
                    overline="NUESTRO EQUIPO" 
                    h2="INSTRUCTORES CERTIFICADOS" 
                    animation={itemAnimation} 
                />

                <Box component={motion.div} variants={itemAnimation} sx={{ position: 'relative', px: { xs: 2, md: 5 }, mt: 6, overflow: 'hidden' }}>
